...
from keras.layers import Lambda, TimeDistributed, Input, Bidirectional, Dense, Embedding, LSTM, SimpleRNN,GRU, RepeatVector,add,subtract,dot
...
def creat_Model_BiLSTM_BP(entvocabsize, relvocabsize, ent2vec, rel2vec, input_path_lenth,
    ...
    path_LSTM = GRU(50, return_sequences=False)(path_embedding)  #!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    path2_LSTM = GRU(80, return_sequences=False)(path2_embedding)   #!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    path3_LSTM = GRU(100, return_sequences=False)(path3_embedding)   #!!!!!!!!!!!!!!!!!!!!!!!!!
...
if __name__ == "__main__":
    ...
    # trainfile = file_mydata + "/WN18RR/path5/WN18RR_train_conflict_5path_random.txt"
    # testfile = file_mydata + "/WN18RR/path5/WN18RR_test_conflict_5path_random.txt"
    ...
    # # trainfile = file_mydata + "/FB15K/path3/FB15K_train_conflict_3path_random.txt"
    # # testfile = file_mydata + "/FB15K/path3/FB15K_test_conflict_3path_random.txt"
    ...
    # # trainfile = file_mydata + "/YAGO3-10/path5/YAGO3-10_train_conflict_5path_random_small.txt"
    # # testfile = file_mydata + "/YAGO3-10/path5/YAGO3-10_test_conflict_5path_random_small.txt"
    # trainfile = file_mydata + "/YAGO3-10/1conflict/YAGO3-10_train_conflict_random_1conflict.txt"
    # testfile = file_mydata + "/YAGO3-10/1conflict/YAGO3-10_test_conflict_random_1conflict.txt"
    ...
    datafile = "./GRU-model/WN18RR_test_TransE.pkl"
    modelfile = "./GRU-model/WN18RR_ALL_model1_TransE_20231111144414.h5"
    resultdir = "./result/"
    resultdir = "./result/Model1_model_WN18RR_ALL_TransE_---"
