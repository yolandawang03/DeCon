...
def creat_Model_BiLSTM_BP(entvocabsize, relvocabsize, ent2vec, rel2vec, input_path_lenth,
    ...
    path_LSTM = LSTM(60, return_sequences=False)(path_embedding)
    ...
    path2_LSTM = LSTM(80, return_sequences=False)(path2_embedding)
    ...
    path3_LSTM = LSTM(100, return_sequences=False)(path3_embedding)
...
if __name__ == "__main__":
    ...
    # trainfile = file_mydata + "/FB15K/path5/FB15K_train_conflict_5path_random.txt"
    # testfile = file_mydata + "/FB15K/path5/FB15K_test_conflict_5path_random.txt"
    ...
    datafile = "./LSTM-model/WN18RR_test_TransE.pkl"
    modelfile = "./LSTM-model/WN18RR_ALL_model1_TransE_20231111141905.h5"
    resultdir = "./result/"
